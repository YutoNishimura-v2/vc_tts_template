...
from vc_tts_template.dsp import mulaw_quantize
from .modules import Conv1d1x1, ResSkipBlock
...
class WaveNet(nn.Module):
    ...
    def inference(self, c, num_time_steps=100, tqdm=lambda x: x):
        ...
        # 逐次的に生成
        # 一見毎回1時刻しか入れていなく, HMMやん! になっているけど,
        # そのためのincremental. 今までの入力を覚えておくということ.
        for t in ts:  # num_time_stepsだけ本当に生成する.
            ...
            # カテゴリカル分布からサンプリング
            # サンプリングするのほんとにおもしろい. argmaxじゃないんだね.
    ...
    def remove_weight_norm_(self):  # いつ使うんだろうね.
