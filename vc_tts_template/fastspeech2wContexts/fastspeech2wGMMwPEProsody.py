...
from vc_tts_template.fastspeech2wContexts.context_encoder import ConversationalProsodyEncoder
...
class Fastspeech2wGMMwPEProsody(FastSpeech2wGMM):
    def __init__(
        self,
        max_seq_len: int,
        num_vocab: int,  # pad=0
    ...
    def forward(
        ...
        output = self.contexts_forward(
            output, max_src_len, h_speakers, h_emotions,
            h_prosody_embs, h_prosody_embs_lens, h_local_prosody_emb_len
        )
